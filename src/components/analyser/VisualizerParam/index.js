...
class VisualizerParam extends React.Component {
    ...
    render() {
        return (
            <section className={VisualizerParam.CLASS_NAME}>
                <section>
                ...
                <section className="codepen">
                    <iframe height='265' scrolling='no' title='Visualizer | XSound - Web Audio API Library -' src='//codepen.io/Korilakkuma/embed/zjpzaq/?height=265&amp;theme-id=0&amp;default-tab=js,result&amp;embed-version=2' frameBorder='no' allowtransparency='true' allowFullScreen='true' style={{ width : '100%' }}>See the Pen <a href='https://codepen.io/Korilakkuma/pen/zjpzaq/'>Visualizer | XSound - Web Audio API Library -</a> by Tomohiro IKEDA (<a href='https://codepen.io/Korilakkuma'>@Korilakkuma</a>) on <a href='https://codepen.io'>CodePen</a>.
</iframe>
                </section>
            </section>
        );
