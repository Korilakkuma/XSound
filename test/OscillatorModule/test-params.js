...
describe('OscillatorModule TEST', () => {
    describe('OscillatorModule#params', () => {
        ...
        it('should return associative array', () => {
            ...
            expect(oscillatorModule.params()).toEqual({
                'oscillator'        : { 'oscillator0' : { 'state' : true, 'type' : 'sine', 'gain' : 1, 'octave' : 0, 'fine' : 0 }, 'glide' : { 'type' : 'linear', 'time' : 0 } },
                'mastervolume'      : 1,
                'stereo'            : { 'state' : false, 'time' : 0 },
                'compressor'        : { 'state' : true, 'threshold' : -24, 'knee' : 30, 'ratio' : 12, 'attack' : 0.003000000026077032, 'release' : 0.25 },
                'distortion'        : { 'state' : false, 'curve' : 'clean', 'samples' : 256, 'pre' : false, 'gain' : 0.5, 'lead' : 0.5, 'post' : false, 'bass' : 0, 'middle' : 0, 'treble' : 0, 'frequency' : 500, 'simulator' : false },
