        ...
        return (
            <section className={Start.CLASS_NAME}>
                ...
                <section className="codepen">
                    <iframe height='265' scrolling='no' title='OscillatorModule#start | XSound - Web Audio API Library -' src='//codepen.io/Korilakkuma/embed/LQbRPr/?height=265&amp;theme-id=0&amp;default-tab=js,result&amp;embed-version=2' frameBorder='no' allowtransparency='true' allowFullScreen='true' style={{ width : '100%' }}>See the Pen <a href='https://codepen.io/Korilakkuma/pen/LQbRPr/'>OscillatorModule#start | XSound - Web Audio API Library -</a> by Tomohiro IKEDA (<a href='https://codepen.io/Korilakkuma'>@Korilakkuma</a>) on <a href='https://codepen.io'>CodePen</a>.
</iframe>
                </section>
            </section>
        );
