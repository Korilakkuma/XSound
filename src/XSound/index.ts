...
export const EQUAL_TEMPERAMENT = 12;
export const FREQUENCY_RATIO   = 2 ** (1 / EQUAL_TEMPERAMENT);  // about 1.059463
export const MIN_A             = 27.5;
export const QUARTER_NOTE      = 4;
export const SHARP             = '#';
export const HALF_UP           = '+';
export const HALF_DOWN         = '-';
export const DOT               = '.';
