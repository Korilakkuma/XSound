            ...
            <nav role="tablist" aria-multiselectable="false" className={Nav.CLASS_NAME}>
                ...
                <section role="presentation">
                    ...
                    <dl id="panel-effectors" aria-hidden={expandedPanelId !== 'panel-effectors'}>
                        ...
                        <dd><Link to={`${this.path}effectors/distortion`} onClick={this.onClickLink}>distortion</Link></dd>
                        <dd><Link to={`${this.path}effectors/envelopegenerator`} onClick={this.onClickLink}>envelopegenerator</Link></dd>
                        <dd><Link to={`${this.path}effectors/equalizer`} onClick={this.onClickLink}>equalizer</Link></dd>
                        <dd><Link to={`${this.path}effectors/filter`} onClick={this.onClickLink}>filter</Link></dd>
                        <dd><Link to={`${this.path}effectors/flanger`} onClick={this.onClickLink}>flanger</Link></dd>
                        <dd><Link to={`${this.path}effectors/glide`} onClick={this.onClickLink}>glide</Link></dd>
                        ...
                        <dd><Link to={`${this.path}effectors/tremolo`} onClick={this.onClickLink}>tremolo</Link></dd>
                        <dd><Link to={`${this.path}effectors/vocalcanceler`} onClick={this.onClickLink}>vocalcanceler</Link></dd>
                        <dd><Link to={`${this.path}effectors/wah`} onClick={this.onClickLink}>wah</Link></dd>
                    </dl>
                </section>
                <section role="presentation">
                    ...
                    <dl id="panel-analyser" aria-hidden={expandedPanelId !== 'panel-analyser'}>
                        ...
                        <dd><Link to={`${this.path}analyser/time-overview/update`} onClick={this.onClickLink}>TimeOverview#update</Link></dd>
                        <dd><Link to={`${this.path}analyser/time-overview/drag`} onClick={this.onClickLink}>TimeOverview#drag</Link></dd>
                    </dl>
                </section>
                <section role="presentation">
