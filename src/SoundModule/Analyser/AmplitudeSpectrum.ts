...
/**
 * This private class visualizes amplitude spectrum.
 */
export class AmplitudeSpectrum extends Spectrum {
  private unit: AmplitudeSpectrumUnit = 'none';
  private renderAmplitudeTexts: ((data: Float32Array) => void) | null = null;
  ...
  /**
   * This method gets or sets parameters for visualizing amplitude spectrum.
   * This method is overloaded for type interface and type check.
   * @param {keyof AmplitudeSpectrumParams|AmplitudeSpectrumParams} params This argument is string if getter. Otherwise, setter.
   * @return {AmplitudeSpectrumParams[keyof AmplitudeSpectrumParams]|PhaseSpectrum} Return value is parameter for visualizing amplitude spectrum if getter.
  ...
  public override param(params: 'unit'): AmplitudeSpectrumUnit;
  public override param(params: AmplitudeSpectrumParams): AmplitudeSpectrum;
  public override param(params: keyof AmplitudeSpectrumParams | AmplitudeSpectrumParams): AmplitudeSpectrumParams[keyof AmplitudeSpectrumParams] | AmplitudeSpectrum {
  ...
  /**
   * This method sets function that render amplitude texts on y coordinate.
   * @param {function|null} renderer This argument is function that render amplitude texts on y coordinate.
   * @return {AmplitudeSpectrum} Return value is for method chain.
   */
  public setRenderAmplitudeTextsFunction(renderer: ((data: Float32Array) => void) | null): AmplitudeSpectrum {
    this.renderAmplitudeTexts = renderer;

    return this;
  }

  /**
   * This method visualizes amplitude spectrum to Canvas.
   * @param {Float32Array} data This argument is frequency domain data amplitude for spectrum.
   * @param {number} minDecibels This argument is in order to determine dB range of amplitude spectrum. The default value is -100 dB.
   * @param {number} maxDecibels This argument is in order to determine db range of amplitude spectrum. The default value is -30 dB.
   * @override
   */
  protected override renderCanvas(data: Float32Array, minDecibels?: number, maxDecibels?: number): void {
    ...
    if ((gridColor !== 'none') || (textColor !== 'none')) {
      ...
      if (typeof this.renderAmplitudeTexts === 'function') {
        this.renderAmplitudeTexts(data);
      } else {
        switch (this.unit) {
          case 'none': {
  ...
  /**
   * This method visualizes amplitude spectrum to SVG.
   * @param {Float32Array} data This argument is frequency domain data for amplitude spectrum.
   * @param {number} minDecibels This argument is in order to determine dB range of amplitude spectrum. Default value is -100 dB.
   * @param {number} maxDecibels This argument is in order to determine db range of amplitude spectrum. Default value is -30 dB.
   * @override
   */
  protected override renderSVG(data: Float32Array, minDecibels?: number, maxDecibels?: number): void {
    if (this.svg === null) {
      return;
    }
